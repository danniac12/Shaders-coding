...
public class Door_Final : MonoBehaviour
{
    ...
    {
        //is the door closed?
        if (_openDoor == 0 && Interfaz.permitir == true)
        {
            puertaFinal.isTrigger = true;
        ...
        if (Interfaz.permitir == false)
        {
            Interfaz.denegar = true;
        }
